...
from app.services.datasource import _get_datasource, build_mysql_connection_url
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            for table_name in tables:
                samples = await get_sample_rows(engine, table_name)
                ...
                columns = await get_columns(engine, table_name)

                for col in columns:
                    column_name = col["COLUMN_NAME"]
                    declared_type = col["DATA_TYPE"]

                    profile = profile_column(samples, column_name)

                    sample_values = [row.get(column_name) for row in samples]
                    ...
                    try:
                        ...
                        enrichment = {"semantic_type": "unknown", "valid_ratio": None}
                    ...
                    await upsert_column_catalog(
                        ...
                        semantic_type=enrichment.get("semantic_type"),
                        valid_ratio=enrichment.get("valid_ratio"),
